...
export interface RuleOptions {
  ...
  /**
   * Force interface naming conventions, support special cases in namespaces.
   */
  'naily/interface-naming'?: Linter.RuleEntry<[]>
  /**
